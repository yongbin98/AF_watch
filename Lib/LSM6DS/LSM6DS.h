...
//================I2C 설정=============================
#define LSM6DS_I2C_PORT hi2c1



extern I2C_HandleTypeDef LSM6DS_I2C_PORT;
#define LSM6DS_DIVECE_ADDR         0xD4
...
void LSM6DS_GetBeing(LSM6DS_AccelSetting *LSM6DS, uint8_t* getDataPointer);
void LSM6DS_GetBeing_polling(LSM6DS_AccelSetting *LSM6DS, uint8_t* getDataPointer);
void LSM6DS_SetAccelSampleRate(uint8_t sampleSetvalue);
void LSM6DS_GetAccelSampleRate(uint8_t* getDataPointer);
...
void LSM6DS_GetAccelTotalData(int16_t* getDataPointer);
void LSM6DS_GetGyroDataX(int16_t* getDataPointer);	//���̷� Z
void LSM6DS_GetGyroDataY(int16_t* getDataPointer);	//���̷� Z
void LSM6DS_GetGyroDataZ(int16_t* getDataPointer);	//���̷� Z
